...
function Library:New(meta)
	...
	function Library.Tab:AddTab(title)
		...
		UIGradient_1.Color = _G.TabColor or ColorSequence.new{ColorSequenceKeypoint.new(0, Color3.fromRGB(255,0,0)),ColorSequenceKeypoint.new(0.5, Color3.fromRGB(255,140,0)),ColorSequenceKeypoint.new(1, Color3.fromRGB(255,140,0))}
		...
		function Library.Section:Section(meta)
			...
			UIListLayout_3:GetPropertyChangedSignal("AbsoluteContentSize"):Connect(function()
				Section_1.Size = UDim2.new(0.980000019, 0, 0, UIListLayout_3.AbsoluteContentSize.Y + 15)
			end)
			...
			function Library.Class:Button(meta)
				...
				UIGradient_1.Color = _G.Theme or Color3.fromRGB(0,255,127)
				...
				clickbutton.MouseButton1Click:Connect(function()
					...
					delay(0.05, function()
						tw({
							...
							s = "Back",
							d = "Out",
							g = {Size = UDim2.new(0.949999988, 0,0, 30)}
						}):Play()
					end)
				end)
			...
			function Library.Class:Toggle(meta)
				...
				UIGradient_1.Color = ColorSequence.new{ColorSequenceKeypoint.new(0, Color3.fromRGB(0, 255, 127)), ColorSequenceKeypoint.new(1, Color3.fromRGB(0, 129, 62))}
					...
					elseif Value then 
						...
						delay(0.05, function()
							tw({
								...
								s = "Bounce",
								d = "Out",
								g = {Size = UDim2.new(0.55, 0,0.55, 0)}
							}):Play()
						end)
					end
				end
			...
			function Library.Class:Dropdown(info)
				...
				function itemslist:AddList(text)
					...
					Line_1.BackgroundColor3 = _G.Theme or Color3.fromRGB(0,255,127)
			...
			function Library.Class:Slider(info)
				...
				Color_1.BackgroundColor3 = _G.Theme or Color3.fromRGB(0,255,127)
				Color_1.BorderColor3 = Color3.fromRGB(0,0,0)
				Color_1.BorderSizePixel = 0
			...
			function Library.Class:Label(text)
				...
				Labelz.Size = UDim2.new(0.949999988, 0, 0, Title_1.TextBounds.Y + 5)
